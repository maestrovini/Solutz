...
import { LogOut, Home, Users, FileText, Building2, Menu, X, User as UserIcon, Landmark, LogIn, Shield, BarChart3, Package, FileSignature, Calculator } from 'lucide-react';
...
export default function Layout({ children, activeTab, setActiveTab }: LayoutProps) {
  ...
  const navItems = [
    ...
    { id: 'costs', label: 'Custas', icon: Calculator },
    { id: 'documents', label: 'Formulários', icon: FileSignature },
    ...(isAdmin ? [
